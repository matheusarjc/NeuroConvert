...
function SecLabel({ children }: { children: React.ReactNode }) {
  return (
    <div className="mb-3 text-[11px] font-bold uppercase tracking-[0.15em] text-[var(--color-primary)]">
      {children}
    </div>
  );
}
    ...
    <div className="min-h-screen bg-[var(--color-bg-base)] text-[var(--color-fg-1)]">
      <nav
        ...
        <Link
          ...
          <KlarivyLockup priority boxClassName="h-16 w-[min(52vw,200px)] sm:w-[200px]" />
        </Link>
        <div className="hidden flex-1 items-center justify-center gap-8 md:flex">
          <a
            href="#metodologia"
            className="text-sm font-medium text-[var(--color-fg-2)] transition-colors hover:text-[var(--color-fg-1)]">
            Metodologia
          </a>
          <a
            href="#como-funciona"
        ...
        <div className="flex flex-1 items-center justify-end gap-2 md:flex-none md:gap-3">
          ...
          <Link
            ...
            Painel
            <span className="ml-1 text-[10px] font-normal text-[var(--color-fg-3)]">(demo)</span>
          </Link>
          <button
            type="button"
            onClick={goAnalyze}
        ...
        <div className="relative z-[1] flex w-full max-w-[1100px] flex-col items-center gap-12 lg:flex-row lg:items-center lg:gap-[72px]">
          <div className="flex w-full flex-1 flex-col gap-5">
            <p className="max-w-[520px] text-xs leading-relaxed text-[var(--color-fg-2)]">
              <span className="font-semibold text-[var(--color-fg-1)]">Para quem é:</span> founders
              e equipas de growth de produtos digitais (SaaS, e-commerce, educação) que querem um
              laudo estruturado antes de investir em redesign ou tráfego pago.
            </p>
            ...
            <p className="max-w-[460px] text-base leading-relaxed text-[var(--color-fg-2)]">
              A <strong className="font-medium text-[var(--color-fg-1)]">Klarivy</strong> identifica
              bloqueios neuropsicológicos na sua página e devolve um laudo com score 0–100,
              benchmark do setor e ações priorizadas — com base na metodologia{" "}
            ...
            <p className="text-[11px] text-[var(--color-fg-3)]">
              Conta gratuita obrigatória · 1 laudo incluído no free · Sem cartão no plano gratuito ·
              Laudo em poucos minutos (depende da página e da fila)
            </p>

            <div className="mt-1 flex flex-wrap gap-2">
              {["Cialdini · Persuasão", "Kahneman · Comportamental", "Nielsen Norman · UX"].map(
                (b) => (
                  <div
                    key={b}
            ...
            <div className="mt-2 flex flex-wrap gap-6 border-t border-[var(--color-border)] pt-4">
              {[
                ...
                <div key={t} className="min-w-[120px]">
                  <div className="font-display text-[15px] font-bold leading-snug tracking-tight text-[var(--color-fg-1)]">
                    {t}
                  </div>
          ...
          <div className="flex w-full max-w-[340px] shrink-0 flex-col gap-2.5 lg:w-[340px]">
            ...
            <div className="flex items-center justify-between rounded-xl border border-[var(--color-border)] bg-[var(--color-bg-surface)] px-4 py-3.5">
              <div>
                <div className="mb-1 text-[9px] font-bold uppercase tracking-[0.07em] text-[var(--color-fg-3)]">
                  Benchmark do setor
                </div>
              ...
              <div className="flex items-center gap-2.5">
                ...
                <span className="font-mono text-[26px] font-bold tracking-tight text-[var(--color-fg-2)]">
                  {SECTOR_SCORE}
                </span>
              </div>
            </div>
            ...
            <div className="rounded-xl border border-[var(--color-border)] bg-[var(--color-bg-surface)] p-5 shadow-[0_20px_60px_rgba(0,0,0,0.5)]">
              <div className="mb-4 flex items-start justify-between">
                <div>
                  <div className="mb-0.5 text-[9px] font-bold uppercase tracking-[0.07em] text-[var(--color-fg-3)]">
                    Sua landing page
                  </div>
                ...
                <div className="flex items-center gap-1.5 rounded-md border border-[color:rgba(239,68,68,0.25)] bg-[var(--color-critical-muted)] px-2 py-0.5">
                  ...
                  <span className="font-mono text-[10px] font-bold text-[var(--color-critical)]">
                    -7 vs. setor
                  </span>
                </div>
              </div>
      ...
      <section id="como-funciona" className="mx-auto max-w-[1100px] px-6 py-20 md:px-10">
        <div className="mb-16 text-center">
          ...
          <p className="mx-auto max-w-[440px] text-base text-[var(--color-fg-2)]">
            Da URL ao laudo com score, benchmark e ações priorizadas — em geral, poucos minutos após
            enviar o pedido.
          </p>
        </div>
        <div className="flex flex-col divide-y divide-[var(--color-border)] border-y border-[var(--color-border)] md:flex-row md:divide-x md:divide-y-0">
          {[
            ...
            <div
              key={s.n}
              className="flex flex-1 flex-col gap-3.5 py-8 first:pt-0 last:pb-0 md:px-8 md:py-0 md:first:pl-0 md:last:pr-0">
              <div className="flex items-center gap-2.5">
              ...
              <h3 className="font-display text-lg font-semibold leading-snug text-[var(--color-fg-1)]">
                {s.title}
              </h3>
      ...
      <section
        id="metodologia"
        className="border-y border-[var(--color-border)] bg-[var(--color-bg-surface)] px-6 py-20 md:px-10">
        <div className="mx-auto grid max-w-[1100px] grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-16">
          <div>
            ...
            <p className="mb-6 text-[15px] leading-relaxed text-[var(--color-fg-2)]">
              Nossa engine de análise combina princípios de neuroeconomia, psicologia da persuasão e
              UX research para identificar os exatos pontos de fricção cognitiva que inibem a
              conversão.
            </p>
            <div className="flex flex-col gap-2.5">
              {[
                [
                  ...
                  "Cialdini 1984 · 6 princípios de influência",
                  "#1D9E75",
                ],
                [
                  "Neuroeconomia Comportamental",
                  "Kahneman & Tversky · Teoria da Perspectiva",
                  "#38BDF8",
                ],
                ...
                <div
                  key={t}
                  className="flex items-center gap-3 rounded-lg border border-[var(--color-border)] bg-[var(--color-bg-elevated)] px-3.5 py-2.5">
          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              <div
                key={m.val}
                className="rounded-[10px] border border-[var(--color-border)] bg-[var(--color-bg-elevated)] p-5">
                <div
                  className="mb-1.5 font-display text-[30px] font-bold leading-none tracking-tight"
                  style={{ color: m.color }}>
                  {m.val}
                </div>
      ...
      <section id="precos" className="mx-auto max-w-[1100px] px-6 py-24 md:px-10">
        <div className="mb-14 text-center">
          ...
          <h2 className="font-display text-3xl font-bold tracking-tight text-[var(--color-fg-1)] md:text-4xl">
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-stretch">
          {[
            ...
            <div
              ...
              <div>
                <div className="font-display text-[15px] font-semibold text-[var(--color-fg-1)]">
                  {pl.name}
                </div>
                <div className="mt-1 text-xs text-[var(--color-fg-2)]">{pl.desc}</div>
              </div>
              <div className="flex items-end gap-0.5">
                <span className="font-display text-[32px] font-bold leading-none tracking-tight text-[var(--color-fg-1)]">
                  {pl.price}
                </span>
        ...
        <div className="mt-8 rounded-xl border border-[var(--color-border)] bg-[var(--color-bg-surface)] p-5">
          <p className="text-[13px] leading-relaxed text-[var(--color-fg-2)]">
            <strong className="text-[var(--color-fg-1)]">Monitorização automática mensal</strong>{" "}
            (re-análise agendada e e-mail comparativo) está em{" "}
            <strong className="text-[var(--color-fg-1)]">roadmap</strong> — não faz parte do produto
            hoje. Os 10 laudos Pro são gerados manualmente na app até lá. Dúvidas ou prioridades:{" "}
            <a
              href="mailto:team@klarivy.com"
      ...
      <footer className="border-t border-[var(--color-border)] px-6 py-12 md:px-10">
        <div className="mx-auto flex max-w-[1100px] flex-wrap justify-between gap-10">
          <div className="max-w-[220px]">
            <div className="mb-3">
              <KlarivyLockup boxClassName="h-12 w-full max-w-[168px]" />
            </div>
          ...
          {[
            ...
            <div key={col.title}>
              <div className="mb-3 text-[10px] font-bold uppercase tracking-wide text-[var(--color-fg-3)]">
                {col.title}
              </div>
                ...
                {col.links.map((l) => (
                  <li key={l}>
                    {l === "Como funciona" ? (
                      <a
                        href="#como-funciona"
                        className="text-[13px] text-[var(--color-fg-2)] hover:text-[var(--color-fg-1)]">
                        {l}
                      </a>
                    ) : l === "Preços" ? (
                      <a
                      ...
                      <span
                        className="cursor-default text-[13px] text-[var(--color-fg-3)]"
                        title="Em breve">
                        {l}
                      </span>
                    )}
        ...
        <div className="mx-auto mt-8 flex max-w-[1100px] justify-between border-t border-[var(--color-border)] pt-6">
          <span className="text-[11px] text-[var(--color-fg-3)]">
            © 2026 Klarivy · metodologia NeuroConvert
          </span>
